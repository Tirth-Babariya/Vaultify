...
export default function GitHubLink({ className = '' }) {
  return (
    <a
      ...
      aria-label="Vaultify on GitHub"
      title="Star Vaultify on GitHub"
      className={`inline-flex items-center justify-center w-10 h-10 rounded-full border border-border bg-foreground/[0.04] text-foreground/80 hover:text-foreground hover:bg-foreground/[0.09] hover:border-foreground/25 transition ${className}`}
    >
