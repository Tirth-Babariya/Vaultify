...
export default function PasswordCard({ item, onDelete, onEdit, isReused, groups = [], onChangeGroup }) {
  ...
  return (
    <div className="card group relative p-4 md:p-5">
      <div className="flex justify-between items-start mb-4 gap-2">
        ...
        <div className="flex flex-shrink-0 items-center md:opacity-0 md:group-hover:opacity-100 md:focus-within:opacity-100 transition-opacity">
          <button
            onClick={onEdit}
