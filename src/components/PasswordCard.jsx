...
export default function PasswordCard({ item, onDelete }) {
  ...
  return (
    <div className="card group relative p-4 md:p-6">
      ...
      <div className="flex items-center space-x-2">
        <div className="flex-1 bg-foreground/5 rounded-md px-3 py-2 font-mono text-sm overflow-hidden text-ellipsis whitespace-nowrap">
